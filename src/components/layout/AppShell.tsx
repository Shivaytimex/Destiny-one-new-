...
type AppShellProps = { children: ReactNode; title: string; eyebrow?: string; actions?: ReactNode };

export default function AppShell({ children, title, eyebrow, actions }: AppShellProps) {
