...
type FeatureCard = { title: string; body: string; meta?: string; href?: string };
type FeatureAction = { label: string; href: string };
type FeatureHero = { kicker?: string; title: string; body: string; metric?: string; metricLabel?: string };
type FeatureHubProps = { eyebrow?: string; title: string; subtitle?: string; hero?: FeatureHero; cards?: FeatureCard[]; actions?: FeatureAction[]; children?: ReactNode };

export default function FeatureHub({ eyebrow, title, subtitle, hero, cards = [], actions = [], children }: FeatureHubProps) {
  return (
